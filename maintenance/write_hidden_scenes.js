...
function buildDefinitions(routes) {
  ...
  // The setup uses actual choices; two optional theatre gestures are omitted.
  const soloBrunetteBus = [
    "start1a",
    "start1b",
    "tuesdaydate",
    "start2",
  ...
  bases.portalooDirect = { ...bases.portalooDiscovery, tags: portalooDirect };
