...
function buildFullCss(ui) {
  ...
  const extra = [
    ...
    "}",
    "/* Cast Age: shrink to header, left-aligned like the other columns */",
    ".wiki-box table.wiki-cast { table-layout: auto; width: 100%; }",
    ".wiki-box table.wiki-cast th:nth-child(3),",
    ".wiki-box table.wiki-cast td:nth-child(3) {",
    "  width: 1%;",
    "  min-width: 3.5em;",
    "  padding-left: 10px;",
